Shader "UI/Blending"
{
  Properties
  {
    ...
    [Enum(UnityEngine.Rendering.BlendMode)] _BlendDestination ("Blend Destination", float) = 1
    ...
    [Toggle(UNITY_PREMULTIPLY_ALPHA)] _UsePremultiplyAlpha ("Premultiply Alpha", float) = 0
  }
  SubShader
  {
    Tags
