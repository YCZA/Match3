...
{
	public class GameEnvironmentSamsungAbroad : AGameEnvironmentConfig
	{
		// eli key point: SbsEnvironmentAndroid()
		public GameEnvironmentSamsungAbroad()
		{
			currentPlatform = GameEnvironment.Platform.Samsung_Abroad;
			...
			this.mapEnvToId = new Dictionary<GameEnvironment.Environment, string>
			{
				...
				{
					GameEnvironment.Environment.STAGING,
					"ovsffalaibe90$0{vb92566s"
				},
				{
					GameEnvironment.Environment.PRODUCTION,
					"iganeabw89b0234];tvg0892"
				}
			};
